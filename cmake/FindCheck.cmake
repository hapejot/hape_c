...
IF( NOT CHECK_FOUND )
        IF ( CHECK_INSTALL_DIR )
                MESSAGE ( STATUS "Using override CHECK_INSTALL_DIR ${CHECK_INSTALL_DIR} to find check" )
                SET ( CHECK_INCLUDE_DIR  "${CHECK_INSTALL_DIR}/include" )
                SET ( CHECK_INCLUDE_DIRS "${CHECK_INCLUDE_DIR}" )
                MESSAGE ( STATUS "include: ${CHECK_INCLUDE_DIR}" )
...
#                SET ( CHECK_LIBRARIES "${CHECK_LIBRARY}" "${COMPAT_LIBRARY}" )
                ...
                message ( STATUS "libs: ${CHECK_LIBRARIES}")
